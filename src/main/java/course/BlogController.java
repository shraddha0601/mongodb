...
public class BlogController {
    ...
    private final BlogPostDataService blogPostDataService;
    ...
    public BlogController(String mongoURIString) throws IOException {
        ...
        blogPostDataService = new BlogPostDataService(blogDatabase);
        userDataService = new UserDataService(blogDatabase);
        sessionDataService = new SessionDataService(blogDatabase);
    ...
    private void initializeRoutes() throws IOException {
        ...
        get(new FreemarkerBasedRoute("/", "blog_template.ftl") {
            ...
            public void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
                String username = sessionDataService.findUserNameBySessionId(getSessionCookie(request));

                List<Document> posts = blogPostDataService.findByDateDescending(10);
        ...
        get(new FreemarkerBasedRoute("/post/:permalink", "entry_template.ftl") {
            ...
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
                ...
                Document post = blogPostDataService.findByPermalink(permalink);
                if (post == null) {
        ...
        post(new FreemarkerBasedRoute("/signup", "signup.ftl") {
            ...
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
                ...
                if (validateSignup(username, password, verify, email, root)) {
                    ...
                    if (!userDataService.addUser(username, password, email)) {
                        // duplicate user
                        ...
                        String sessionID = sessionDataService.startSession(username);
        ...
        post(new FreemarkerBasedRoute("/newpost", "newpost_template.ftl") {
            ...
            protected void doHandle(Request request, Response response, Writer writer)
                ...
                if (username == null) {
                    ...
                    String permalink = blogPostDataService.addPost(title, post, tagsArray, username);
        ...
        get(new FreemarkerBasedRoute("/welcome", "welcome.ftl") {
            ...
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
                ...
                String username = sessionDataService.findUserNameBySessionId(cookie);
        ...
        post(new FreemarkerBasedRoute("/newcomment", "entry_template.ftl") {
            ...
            protected void doHandle(Request request, Response response, Writer writer)
                ...
                // check that comment is good
                    ...
                    blogPostDataService.addPostComment(name, email, body, permalink);
                    response.redirect("/post/" + permalink);
                }
            }
        });
        ...
        post(new FreemarkerBasedRoute("/login", "login.ftl") {
            ...
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
                ...
                Document user = userDataService.validateLogin(username, password);

                if (user != null) {

                    // valid user, let's log them in
                    String sessionID = sessionDataService.startSession(user.get("_id").toString());
        ...
        get(new FreemarkerBasedRoute("/tag/:thetag", "blog_template.ftl") {
            ...
            protected void doHandle(Request request, Response response, Writer writer)
                ...
                List<Document> posts = blogPostDataService.findByTagDateDescending(tag);
        ...
        post(new FreemarkerBasedRoute("/like", "entry_template.ftl") {
            ...
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
                ...
                if (post == null) {
                    ...
                    blogPostDataService.likePost(permalink, ordinal);
        ...
        get(new FreemarkerBasedRoute("/logout", "signup.ftl") {
            ...
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
                ...
                if (sessionID == null) {
                    ...
                    sessionDataService.endSession(sessionID);
